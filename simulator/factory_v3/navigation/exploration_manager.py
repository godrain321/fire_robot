    ...
    def plan_next_exit(
        ...
        if not plan.success:
            return ExplorationPlan(
                ...
                int(costmap_revision), float(created_at),
                plan.failure_reason.value, plan,
            )
        return ExplorationPlan(
